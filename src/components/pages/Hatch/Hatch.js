	...
	return (
		<>
			...
			<div style={{marginTop: '20px'}}>
				<TextSapn>Hached Eggs: {hatchCount}</TextSapn></div>
			<Title>
				<TextSapn1>inKUbator</TextSapn1>
			</Title>
			<MintWraper style={{ paddingBottom: 20 }}>
				<MintBackground1>
					<MintTitle style={{ padding: 10 }}>
						<span>CONNECT TO BOTH CHAINS TO USE A KU CORP. INKUBATOR AND HATCH YOUR KU EGG</span>
					</MintTitle>
				</MintBackground1>
			</MintWraper>
				...
				<HatchPriceDiv>
					<HatchConnectDiv>
						{!account || !props.kuWallet ? (
							<div style={{ color: '#C7CCD1', fontSize: '14px', textAlign: 'center' }}>
								CONNECT KUSAMA AND EXOSAMA WALLETS
							</div>
						) : (null)}
					</HatchConnectDiv>
					{account && props.kuWallet && <div className="kore-button-div">
						{isHatching ?
